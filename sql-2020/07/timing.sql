--tempo_medio_venda = avg_diff_dias


create table IF NOT EXISTS tb_audiencia_venda as
with tb_marcacao_seller as (
    select t2.seller_id,
        ...
        '2018-07-01' as dt_atual,
            ...
            case when julianday('2018-07-01') - julianday(max(t1.order_approved_at)) > t3.avg_diff_dias
                then 1 else 0
